    ...
    var RestaurantView = Backbone.View.extend({
        ...
        loadPlugins: function(){
            ...
            var locations = new Bloodhound({
              ...
              local: $.map(window.collections.localities.reverse(), function(locality) { return { value: locality.name, key: locality.id }; })
            });
            ...
            var delivers_in = new Bloodhound({
              ...
              datumTokenizer: Bloodhound.tokenizers.obj.whitespace('value'),
              queryTokenizer: Bloodhound.tokenizers.whitespace,
              local: $.map(collections.groups, function(group) { return { value: group.name, key: group.id }; })
            });
