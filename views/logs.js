            ...
            if(options.id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        that.data=_.groupBy(data.message.versions, function(num,i){ return Math.floor(i/10); });
            ...
            _.each(versions,function(version){
                _.each(version.diff,function(value,key,item){
                    if(typeof(value[0])==='object' && typeof(value[1])==='object') {
                        ...
                        value[0] = _.reject(value[0],function(el) { return _.contains(remove_similar_objects,el.Id);  });
                        value[1] = _.reject(value[1],function(el) { return _.contains(remove_similar_objects,el.Id); });
                        ...
                        value[1] = _.reject(value[1],function(el) { return _.contains(_.pluck(diff,'Id'),el.Id); });
                        //Sort the two arrays
