...
{ 
  'use strict';
    var DeletedRestaurantView = Backbone.View.extend({

        el: '#page',
        template: JST['app/scripts/templates/deleted_restaurants.ejs'],
        ...
        render: function (options) {
            ...
            start_loading();
            restaurants.url = "/restaurants/delete";
